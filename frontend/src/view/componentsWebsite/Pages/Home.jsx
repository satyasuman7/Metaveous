  ...
  return (
    <>
      <section className="hero-section position-relative py-5">
            ...
            <Col lg={10}>
              ...
              <div className="d-flex flex-column flex-sm-row justify-content-center gap-3">
                <Link to="#" className="btn btn-primary px-4 py-3 fw-semibold">
                  <ImPhone size={21} className='me-2' />Contact Us
                </Link>

                <Link to="#" className="btn btn-dark px-4 py-3 fw-semibold">
                  <GiGiftOfKnowledge size={21} className='me-2' /> Know More
                </Link>
              </div>
            </Col>
          </div>
        ...
        {/* Top Right SVG */}
        <div className="hero-svg-top opacity-50">
        ...
        {/* Bottom Left SVG */}
        <div className="hero-svg-bottom opacity-50">
